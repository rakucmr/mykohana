...
class Controller_Admin_Articles extends Controller_Admin_Index{
	...
	public function action_add(){
		if(isset($_POST['submit'])){
			...
			$data = Arr::extract($_POST, array('article_title', 'article_alias', 'article_text', 'article_status'));
	...
	// Редактирование
        if (isset($_POST['submit'])) {
            $data = Arr::extract($_POST, array('article_title', 'article_alias', 'article_text'));
            $pages->values($data);
