...
<form action="/admin/pages/add" method="post">
	...
	<ul >
	<li>Название странийы<input style="width:350px;" type="text" name="page_title" value="<?=$data['page_title']?>"></li>
	<li>Алиас <input type="text" name="page_alias" value="<?=$data['page_alias']?>"></li>
	<li>
	<textarea id="elm1" name="page_text" ><?=$data['page_text']?></textarea>
	</li>
