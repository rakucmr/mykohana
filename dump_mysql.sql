...
--
-- Хост: localhost
-- Время создания: Авг 20 2012 г., 15:50
...
CREATE TABLE IF NOT EXISTS `admins` (
  ...
  `admin_login` varchar(20) CHARACTER SET ascii NOT NULL,
  `admin_password` varchar(36) CHARACTER SET ascii NOT NULL,
  `admin_email` varchar(50) CHARACTER SET ascii NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banners` (
  ...
  `banner_url` varchar(100) CHARACTER SET ascii NOT NULL,
...
INSERT INTO `banners` (`banner_id`, `banner_title`, `banner_url`, `banner_image`) VALUES
(15, 'Asus', '', 'msq9x4r7ou6eka8z.jpg'),
(16, 'Ноутбук Sony Vaio', '', 'hyje9vtlw30g1zb7.jpg'),
(17, 'Фотоаппарат Nikon D3100', '', 'g2yxl8mtodiea051.jpg'),
(18, 'PocketBook pro', '', '8aulqwvx7p3mrh45.jpg'),
(19, 'Новый iPad', '', 'xwj8cyl1kms24h3d.jpg');
...
INSERT INTO `categories` (`id`, `category_title`, `parent_id`, `lft`, `rgt`, `lvl`, `scope`) VALUES
(1, 'Компьютеры', 0, 1, 2, 1, 1),
(2, 'Ноутбуки', 0, 1, 8, 1, 2),
(30, 'Samsung', 8, 2, 3, 2, 3),
(29, 'Acer', 2, 6, 7, 2, 2),
(28, 'Asus', 2, 4, 5, 2, 2),
(8, 'Мониторы', 0, 1, 4, 1, 3),
(9, 'Принтеры', 0, 1, 4, 1, 4),
(10, 'Сканеры', 0, 1, 2, 1, 5),
(11, 'Фото и Видео Техника', 0, 1, 2, 1, 6),
(13, 'Автомобили', 0, 1, 2, 1, 7),
(32, 'Caneon', 9, 2, 3, 2, 4);
...
INSERT INTO `countries` (`country_id`, `country_name`, `iso_code_2`, `iso_code_3`, `status`) VALUES
(1, 'Афганистан', 'AF', 'AFG', 1),
(2, 'Албания', 'AL', 'ALB', 1),
(3, 'Алжир', 'DZ', 'DZA', 1),
(4, 'Восточное Самоа', 'AS', 'ASM', 1),
(5, 'Андорра', 'AD', 'AND', 1),
(6, 'Ангола', 'AO', 'AGO', 1),
(7, 'Ангилья', 'AI', 'AIA', 1),
(8, 'Антарктида', 'AQ', 'ATA', 1),
...
(20, 'Белоруссия (Беларусь)', 'BY', 'BLR', 1),
(21, 'Бельгия', 'BE', 'BEL', 1),
(22, 'Белиз', 'BZ', 'BLZ', 1),
(23, 'Бенин', 'BJ', 'BEN', 1),
(24, 'Бермудские острова', 'BM', 'BMU', 1),
(25, 'Бутан', 'BT', 'BTN', 1),
(26, 'Боливия', 'BO', 'BOL', 1),
...
(31, 'Британская территория в Индийском океане', 'IO', 'IOT', 1),
(32, 'Бруней', 'BN', 'BRN', 1),
...
(67, 'Эстония', 'EE', 'EST', 1),
(68, 'Эфиопия', 'ET', 'ETH', 1),
(69, 'Фолклендские (Мальвинские) острова', 'FK', 'FLK', 1),
...
(92, 'Гайана', 'GY', 'GUY', 1),
(93, 'Гаити', 'HT', 'HTI', 1),
(94, 'Херд и Макдональд, острова', 'HM', 'HMD', 1),
...
(112, 'Корейская Народно-Демократическая Республика', 'KP', 'PRK', 1),
(113, 'Республика Корея', 'KR', 'KOR', 1),
(114, 'Кувейт', 'KW', 'KWT', 1),
(115, 'Киргизия (Кыргызстан)', 'KG', 'KGZ', 1),
(116, 'Лаос', 'LA', 'LAO', 1),
(117, 'Латвия', 'LV', 'LVA', 1),
(118, 'Ливан', 'LB', 'LBN', 1),
(119, 'Лесото', 'LS', 'LSO', 1),
...
(151, 'Антильские (Нидерландские) острова', 'AN', 'ANT', 1),
...
(159, 'Северные Марианские острова', 'MP', 'MNP', 1),
...
(217, 'Острова Теркс и Кайкос', 'TC', 'TCA', 1),
(218, 'Тувалу', 'TV', 'TUV', 1),
(219, 'Уганда', 'UG', 'UGA', 1),
(220, 'Украина', 'UA', 'UKR', 1),
(221, 'Объединенные Арабские Эмираты', 'AE', 'ARE', 1),
(222, 'Великобритания', 'GB', 'GBR', 1),
(223, 'Соединенные Штаты Америки', 'US', 'USA', 1),
(224, 'Мелкие отдаленные острова США', 'UM', 'UMI', 1),
...
(231, 'Виргинские острова (Британские)', 'VG', 'VGB', 1),
(232, 'Виргинские острова (США)', 'VI', 'VIR', 1),
(233, 'Уоллис и Футуна', 'WF', 'WLF', 1),
(234, 'Западная Сахара', 'EH', 'ESH', 1),
(235, 'Йемен', 'YE', 'YEM', 1),
(236, 'Сербия и Черногория', 'CS', 'SCG', 1),
(237, 'Заир', 'ZR', 'ZAR', 1),
(238, 'Замбия', 'ZM', 'ZMB', 1),
...
--
-- Структура таблицы `delivery_metods`
--

CREATE TABLE IF NOT EXISTS `delivery_metods` (
  `delivery_id` int(11) NOT NULL AUTO_INCREMENT,
  `delivery_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `delivery_alias` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `delivery_price` double NOT NULL,
  PRIMARY KEY (`delivery_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;

--
-- Дамп данных таблицы `delivery_metods`
--

INSERT INTO `delivery_metods` (`delivery_id`, `delivery_title`, `delivery_alias`, `delivery_price`) VALUES
(1, 'РОССИЙСКАЯ ДОСТАВКА', '', 0),
(2, 'Почта россии', '', 0),
(3, 'Самовывоз', '', 0),
(4, 'Доставка по городу', 'city', 0),
(5, 'Доставка по областьи', 'Ob', 0);
...
(1, 13, 'v8xuspj37a1ozrgf.jpg'),
(2, 13, 'hu91sxjfwcoz46g0.jpg'),
(3, 13, 'i80o59cfanzmrlg6.jpg'),
(4, 14, 'td18pima2owfu0vk.jpg'),
(5, 14, 'wljiu1pcg38o4zft.jpg'),
(6, 14, 'il1hpmuok3ts8d46.jpg'),
(7, 15, '3m4p291aevswyjih.jpg'),
(8, 15, 'b7ysj364ap1g8txn.jpg'),
(9, 16, 'j9atpgx7skzvf24e.jpg'),
(10, 17, 'rci6nkgywfxzp295.jpg'),
(11, 17, '0ugk3h5mtaq1vixb.jpg'),
(12, 17, 'oydperh43camflg6.jpg'),
(30, 19, '1hwuviqa652x0bpd.jpg'),
(29, 18, 'huqn5aplcti4dr1s.jpg'),
(28, 18, 'rnwps6710i5k2hgv.jpg'),
(25, 0, 'p1yvkxh0d24lgbe5.jpg'),
(26, 0, '3x8gbc9u2wjfd47r.jpg'),
(27, 18, 'gblcu9fnvy431xe8.jpg'),
(31, 20, 'yothgiz7x2bkeqn1.jpg'),
(32, 21, 'wi86op5zysngjbl9.jpg'),
(36, 22, 'wntm2x7hdopbrck6.jpg'),
(35, 23, 'exvsktn56mgoq7h9.jpg'),
(37, 22, '1i380jqo4ndlawpe.jpg'),
(38, 22, '153u6bsc72yie9qo.jpg'),
(39, 24, '5rsgfbch6juxqm9z.jpg'),
(40, 33, 'g0zcibu6dav3ep27.jpg'),
(41, 35, 'iwafyl108b2mdejs.jpg'),
(42, 36, 'g18j7em3xwp9sv24.jpg');
...
INSERT INTO `manufactures` (`id`, `title`, `alias`, `url`, `image`) VALUES
(1, 'Asus', 'asus', 'Asus.com', '8hfgi1ynvlr0z4c6.jpg'),
(2, 'Acer', 'acer', 'acer.com', 'qwglnmrv9h5bsdu7.jpg'),
(3, 'Samsung', 'samsung', 'samsung.com', '56db4tl102zkua9i.jpg'),
(4, 'HP', 'hp', 'hp.com', '5jzidlnc64q8hwyb.jpg'),
(42, 'Toshiba', 'toshiba', 'toshiba.com', 'duq7n5s3w4xtgrom.jpg'),
(43, 'Dell', 'dell', 'dell.com', 'gdom693rskx71fq0.jpg'),
(44, 'Benq', 'benq', 'benq.com', 'kqjco3mp1fwa0su9.jpg'),
(45, 'Apple', 'apple', 'apple.com', 'apple.jpg');
...
CREATE TABLE IF NOT EXISTS `modules` (
  ...
  `module_position` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `module_order` int(1) NOT NULL,
...
INSERT INTO `modules` (`module_id`, `module_name`, `module_title`, `module_position`, `module_order`, `module_status`) VALUES
(1, 'delivery_metods', 'Модуль доставки', '', 1, 1),
(2, 'Payment', 'Модуль оплаты', '', 2, 1);
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `page_alias` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `pages` (`page_id`, `page_title`, `page_alias`, `page_text`) VALUES
(1, 'Способы оплаты', 'pay', '\r\n<p>\r\n	На данный момент из способов оплаты мы принимаем только наличные. Наш курьер доставит Вам Ваш заказ, а так же предоставит все необходимые документы. <br>\r\n	<br>\r\n	За оказание услуги доставки Товара с покупателя взимается стоимость услуги доставки в соответствии с условиями по доставке. Вы оплачиваете заказ наличными курьеру при его получении.<br>\r\n	<br>\r\n	Вместе с заказом Вы получаете товарный чек, содержащий все товарные позиции вашего заказа.<br>\r\n	<br>\r\n	Если у Вас остались какие-либо вопросы, Вы всегда можете связаться с нами по контактному телефону (4212) 201-899 или через форму на странице Контакты.</p>'),
(2, 'Контакты', 'contacts', 'asdsadnmnmnmnmn'),
(3, 'Доставка', 'delivery', '<p>\r\n	<strong>Доставка товара, заказанного в нашем магазине:</strong></p>\r\n<ul>\r\n	<li>\r\n		Доставка Вашего заказа осуществляется только в случае подтверждения вашего заказа по телефону, менеджером</li>\r\n	<li>\r\n		Доставка Вашего заказа осуществляется нашей курьерской службой по указанному адресу в указанный период. В случае не возможности осуществления доставки в выбранный день, менеджер свяжется с вами и сообщит об этом и перенесет дату.</li>\r\n	<li>\r\n		Конечная дата доставки утверждается менеджером</li>\r\n	<li>\r\n		Доставка производится бесплатно, если сумма вашего заказа превышает 5 000 рублей. Если сумма заказа меньше, то стоимость доставки составит 300 рублей</li>\r\n	<li>\r\n		Доставка по городу Хабаровску каждый день, кроме воскресенья.</li>\r\n</ul>\r\n<p>\r\n	<strong>Внимание!</strong></p>\r\n<p>\r\n	Если непредвиденные обстоятельства мешают Вам получить заказ или Вы решили отказаться от заказа до его доставки, Вам необходимо как можно раньше связаться с оператором по телефону: (4212) 201-899. <br>\r\n	Перед доставкой заказа Вам необходимо подготовить условия для беспрепятственного доступа сотрудников службы доставки: освободить проходы и лестничные пролеты, место в квартире и т.д. Постарайтесь не занимать указанный Вами контактный телефон. <br>\r\n	В случае отсутствия покупателя в назначенное время, сотрудники доставки уезжают, оставляя соответствующее уведомление. <br>\r\n	Повторная доставка товара осуществляется за плату на общих условиях. <br>\r\n	<br>\r\n	Дополнительную информацию можно получить у наших консультантов<br>\r\n	<br>\r\n	<strong>Обращаем Ваше внимание на следующее:</strong></p>\r\n<ul>\r\n	<li>\r\n		сотрудники службы доставки не осуществляют проверку работоспособности техники. Весь товар проверяется продавцами-консультантами в обязательном порядке непосредственно перед доставкой;</li>\r\n	<li>\r\n		сотрудники службы доставки не оказывают услуги по переносу мебели внутри квартиры и не выполняют работы, связанные с привлечением механических средств;</li>\r\n	<li>\r\n		доставка в коттеджные дома осуществляется при наличии подъездных путей;</li>\r\n	<li>\r\n		служба доставки не производит подключение техники, и не дает консультаций по ее эксплуатации. Если приобретенный товар требует подключения, вам необходимо обратиться сервисный центр и вызвать специалиста. Это можно сделать сразу при оформлении доставки или по телефону: (4212) 201-899.</li>\r\n</ul>\r\n<p>\r\n	<br>\r\n	<strong>Получение товара</strong></p>\r\n<ul>\r\n	<li>\r\n		<strong>Обязательно убедитесь в отсутствии дефектов и комплектности товара, прежде чем расписаться в путевом листе.</strong> Сотрудник, осуществляющий доставку, обязан выдать товарный чек и (в случае оплаты наличными также приходный ордер), заполненный гарантийный талон со штампами. При наличии претензий к внешнему виду и комплектности товара Вы можете отказаться от товара.</li>\r\n	<li>\r\n		<strong>Перед тем, как начать пользоваться товаром, проверьте, соответствует ли ваше представление о товаре его реальным характеристикам.</strong> Если товар не устраивает ваc по каким-либо характеристикам, мы без проблем его поменяем или вернем деньги.</li>\r\n	<li>\r\n		<strong>При обнаружении скрытых дефектов в товаре сразу сообщите нам об этом</strong> любым удобным способом. Обмен товара или возврат денежных средств Покупателю осуществляется после проведения экспертизы сервисного центра в сроки, установленные действующим законодательством.</li>\r\n</ul>\r\n<p>\r\n	<br>\r\n	<strong>Установка и подключение техники</strong><br>\r\n	<br>\r\n	Если приобретенная техника требует подключения, вам необходимо обратиться в сервисный центр и вызвать специалиста. <strong>Доставщики подключением не занимаются.</strong> Вызов мастера <strong>платный</strong>. Работа и расходные материалы также <strong>оплачиваются отдельно</strong>. Расценки на подключение узнавайте по телефону в Хабаровске (4212) 201-899.<br>\r\n	<br>\r\n	<strong>Как можно отменить заказ до его доставки?</strong><br>\r\n	<br>\r\n	Зайдите в магазин с вашим именем и паролем. Заходите в "Историю заказов", там вы можете удалить заказ до получения товара. Если вы не регистрировались при оформления заказа, то напишите нам письмо или позвоните.<br>\r\n	<br>\r\n	<strong>Прежде чем начать эксплуатацию:</strong><br>\r\n	<br>\r\n	Прежде чем начать эксплуатацию, рекомендуем Вам внимательно ознакомиться с условиями эксплуатации, указанными в инструкции.<br>\r\n	Если У Вас возникают дополнительные вопросы, Вы всегда можете связаться с нашими консультантами по тел.: (4212) 201-899.</p>\r\n '),
(4, ' О нас', 'about', '<p style="text-align: justify;">\r\n	MagazinDV.ru - первый хабаровский несетевой интернет-магазин, специализирующийся на продаже всех видов бытовой техники отечественного и зарубежного производства.<br>\r\n	<br>\r\n	Наш магазин начал работать в 2011 году и ставит своей задачей повышение доступности бытовой техники для всех слоёв населения, максимальное снижение и затрат сил и времени на выбор и покупку техники покупателем, а также предоставление потенциальным клиентам информации, необходимой для успешного выбора той или иной бытовой техники.<br>\r\n	<br>\r\n	Наш опыт работы в рынке бытовой техники позволил создать, стабильные отношения с деловыми партнерами. В нашем ассортименте Вы можете найти такие успешно зарекомендовавшие себя на зарубежных и отечественных рынках компании как Атлант, Саратов, Гефест, Бирюса, Bosch, Siemens, Candy, Electrolux, Hoover, LG Electronics, Daewoo и многие другие. Список постепенно будет расширяться и перечень товаров не является исчерпывающим.<br>\r\n	<br>\r\n	Принимая во внимание жесткую конкуренцию на рынке бытовой и цифровой техники, мы стараемся предложить нашим покупателям максимальный выбор продукции с лучшим соотношением цена/качество. <br>\r\n	<br>\r\n	Наша корпоративная политика подразумевает внимательное и предупредительное отношение к клиенту. Мы действительно заинтересованы в том, чтобы купленная у нас техника служила ее владельцам долго и исправно, а клиент снова вернулся в наш магазин. <br>\r\n	<br>\r\n	Вся бытовая техника, приобретенная в MagazinDV.ru, в случае неисправности обслуживается по гарантии сервис-центрами г.Хабаровска, авторизованными Производителями, на основании гарантийных талонов, прилагаемых к технике самими Производителями. <br>\r\n	<br>\r\n	Перечень сервисных центров, их адреса и брэнды, по которым они имеют авторизацию, Вы можете найти на нашем сайте в разделе "Сервисные центры". Если при общении с Авторизованными сервисами у наших клиентов возникают проблемы – мы всегда придем на помощь.<br>\r\n	<br>\r\n	Ежедневная работа всех сотрудников проекта MauazinDV.ru призвана удовлетворить потребности самых взыскательных клиентов. Искреннее желание помочь каждому клиенту, опыт и высокий профессионализм наших сотрудников, надеемся, оставят у Вас самое приятное впечатление. И Вам снова захочется обратиться в наш интернет-магазин. Приятных Вам покупок!</p>');

-- --------------------------------------------------------

--
-- Структура таблицы `payment_metods`
--

CREATE TABLE IF NOT EXISTS `payment_metods` (
  `payment_id` int(11) NOT NULL AUTO_INCREMENT,
  `payment_title` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `payment_html` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`payment_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;

--
-- Дамп данных таблицы `payment_metods`
--

INSERT INTO `payment_metods` (`payment_id`, `payment_title`, `payment_html`) VALUES
(1, 'Банковской картой VISA, MasterCard', ''),
(2, 'Яндекс-деньги', '<center>\r\n</br></br>\r\n<font size="6">Оплата Яндекс.Деньги</font>\r\n</br></br>\r\n<font size="3" color="red">\r\nВНИМАНИЕ!<br />\r\nСумма платежа указана с учётом комиссии платёжной системы Яндекс (+0.5%)</font><br />\r\n<font size="2"><b>Итого к оплате:</b> <?php echo $total_price." руб. (сумма заказа) + ".round($total_price*0.00502333333,2)." руб. (комиссия Яндекс) = ".round($total_price+$total_price*0.00502333333,2)." руб." ?>\r\n</br></br>\r\n<i>Если у Вас возникли вопросы, телефон для справок: <?php echo $bankuser ?></i></font>\r\n</br></br>\r\n<iframe frameborder="0" allowtransparency="true" scrolling="no"\r\n	src="https://money.yandex.ru/embed/shop.xml?uid=<?php echo $bank ?>&amp;writer=seller&amp;targets=%d0%9e%d0%bf%d0%bb%d0%b0%d1%82%d0%b0+%d0%b7%d0%b0%d0%ba%d0%b0%d0%b7%d0%b0+%e2%84%96+<?php echo $order_id ?>&amp;default-sum=<?php echo round($amount+$amount*0.00502333333,2) ?>&amp;button-text=01&amp;hint=" \r\n	scrolling="no" width="450" frameborder="0" height="163">\r\n</iframe>\r\n</br></br>\r\n<font size="3"><?php echo $inn ?> - <a href="<?php echo $rs ?>"><?php echo $rs ?></a></font>\r\n</center>\r\n<!-- Yandex.Metrika counter -->\r\n<script type="text/javascript">\r\n(function (d, w, c) {\r\n    (w[c] = w[c] || []).push(function() {\r\n        try {\r\n            w.yaCounter13218340 = new Ya.Metrika({id:13218340, enableAll: true});\r\n        } catch(e) {}\r\n    });\r\n    \r\n    var n = d.getElementsByTagName("script")[0],\r\n        s = d.createElement("script"),\r\n        f = function () { n.parentNode.insertBefore(s, n); };\r\n    s.type = "text/javascript";\r\n    s.async = true;\r\n    s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//mc.yandex.ru/metrika/watch.js";\r\n\r\n    if (w.opera == "[object Opera]") {\r\n        d.addEventListener("DOMContentLoaded", f);\r\n    } else { f(); }\r\n})(document, window, "yandex_metrika_callbacks");\r\n</script>'),
(3, 'Киви', ''),
(4, 'z-payment', ''),
(5, 'Сбербанк квитанция', '');
...
INSERT INTO `settings` (`setting_id`, `title`, `meta_description`, `meta_keywords`) VALUES
(1, 'sdfsdf', 'sd fds fdsf sdfds', ' fsdds fdsfsdfsd');
...
CREATE TABLE IF NOT EXISTS `site_settings` (
  ...
  `site_meta_description` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `site_meta_keywords` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `first_name`, `phone`, `address`, `country_id`, `zone_id`, `regdate`, `status`, `logins`, `last_login`) VALUES
(6, 'admin@localhost.loc', 'admin', 'b9662379e43c5aba4e8d5e3ab4d9bfe91d4fa2b3040f3f6b103c88c7e4ea22c6', 'Администратор', '89257856421', '', 0, 0, '0000-00-00', 1, 0, 1345415379),
(19, 'root@localhost.loc', 'root', '0c48f96534e4377866113607f7577b575751b3a4bd73a92778b9154d2e707c74', 'root', '8926532689', '', 0, 0, '0000-00-00', 1, 12, 1344877043),
(20, 'artur85@yandex.ru', 'artur', 'artur', 'artur petrosyan', '89255685252', 'sdffdsf', 176, 0, '0000-00-00', 0, 0, NULL),
(21, 'artuwr85@yandex.ru', 'arturx', 'arturx', 'artur petrosyan', '89255685252', 'sdffdsf', 176, 0, '0000-00-00', 0, 0, NULL),
(22, 'aaaa@sdfsfs.ru', 'aaaaa', 'aaaaa', 'aaaaa', '89255685252', 'sdfsdfs', 176, 0, '0000-00-00', 0, 0, NULL),
(23, 'aaaa@sffdsdfsfs.ru', 'fsdfdffds', 'aaaaa', 'aaaaaaa', '89255685252', 'dssf', 176, 0, '0000-00-00', 0, 0, NULL);
...
(1, 6, 'bdee0a7228a2832124637cbfac86a7e49d0b847a', '336845b2dcc8f9926238cc27f08549f93084be9a', '', 0, 1345325988);
...
CREATE TABLE IF NOT EXISTS `zones` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`zone_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3969 ;

--
-- Дамп данных таблицы `zones`
--

INSERT INTO `zones` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
(1, 1, 'BDS', 'Бадахшан', 1),
(2, 1, 'BDG', 'Бадгис', 1),
(3, 1, 'BGL', 'Баглан', 1),
(4, 1, 'BAL', 'Балх', 1),
